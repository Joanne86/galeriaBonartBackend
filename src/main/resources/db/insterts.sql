...
insert into artist values ('1234567890', 'JohnART', 'candelaria','3125256290', 'bogota', 'museo de arte moderno');
insert into artist values ('5987632145', 'HaroldART', 'suba','3007632356', 'bogota', 'museo de arte moderno');

insert into seller values ('1014293632', 'Leidy Yohana Rodriguez Fuentes', '3135678435');
...
insert into sesion values ('4','admin', 'Colombia4', '5434544576');
...
insert into artwork values (3, 'micheal jackson en acuarela', 0, '5987632145', 1);
...
insert into artwork values (10, 'Recien casados piedra', 12000000, '5987632145', 2);

insert into artwork values (7, 'marilyn monroe en tela', 2800000, '1014293634', 3);
insert into artwork values (8, 'luna llena lana', 3000000, '5987632145', 3);
...
insert into customer values ('4345632784', 'Melissa Gonzales Huertas', '3227535276', 'melisa@gmail.com', 1, 1);
